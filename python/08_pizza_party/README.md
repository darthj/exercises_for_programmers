...
* Alter the output so it handles pluralization properly, for example: Each person gets 2 pieces, or each person gets 1 piece of pizza. Handle the output for leftover pieces appropriately as well.
